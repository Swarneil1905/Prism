    ...
    <>
      ...
      <nav className="nav" id="nav">
        ...
        <div className="nav-links">
          ...
          <a href="#">Docs</a>
          <a href="https://github.com/Swarneil1905/prism" target="_blank" rel="noreferrer">GitHub</a>
          <a href="#">Pricing</a>
        </div>
        <div className="nav-actions">
          <a href="/traces" className="btn btn-google" style={{textDecoration:"none"}}>
          ...
          <a href="/traces" className="btn btn-getstarted" style={{textDecoration:"none"}}>Get Started</a>
        </div>
      </nav>
      ...
      <header className="hero">
        ...
        <div className="hero-inner">
          ...
          <div className="cta-row">
            <a href="/traces" className="btn btn-primary" style={{textDecoration:"none"}}>Start for free</a>
            <a href="https://github.com/Swarneil1905/prism" target="_blank" rel="noreferrer" className="btn btn-secondary" style={{textDecoration:"none"}}>View on GitHub</a>
          </div>
